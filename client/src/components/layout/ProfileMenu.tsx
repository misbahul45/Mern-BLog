...
const ProfileMenu = ({ avatar,username, email }:Props) => {
  ...
  return (
    <div className="relative lg:block hidden">
        ...
        {showMenu&&(
            <div className="animate-show-profile-menu px-2.5 py-2 absolute top-[120%] -right-10 border-2 backdrop-blur-md rounded-xl bg-black/10 dark:bg-white/10">
                <h1 className="text-xl font-bold dark:text-slate-400">{username}</h1>
