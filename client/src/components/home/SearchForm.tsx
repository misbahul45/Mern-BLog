...
const SearchForm = ({ searchItem, setSearchItem }:Props) => {
  ...
  return (
    <div className="w-full max-w-xl relative flex items-center gap-2 mt-4">
      <input type="text" placeholder="Search..." value={searchItem} onChange={onChange} className="outline-none w-full py-1.5 pl-8 dark:text-slate-100 placeholder:text-slate-400 bg-transparent border-b-2 border-b-slate-400 focus:border-b-slate-800 dark:border-b-slate-700 focus:dark:border-b-slate-300 peer" />  
